...
## P11 resume
P11+ (glass/transitions/QA/micro-pass) — все 6 пунктов F1–F6 закоммичены
(c213ead…09fad98), typecheck+build+clippy чистые. Осталось:
скриншоты 8 ключевых поверхностей для ручной сверки (docs/UI-QA.md — список)
→ затем P7 C3 (поповер раскладок коллажа) и старые хвосты выше.
